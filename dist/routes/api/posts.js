...
// @desc Create a post
// @access Private
router.post("/", [auth, check("text", "Text is required to make a post.").not().isEmpty()], function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
router.get("/:id", auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Post.findById(req.params.id).sort({ date: -1 })];
            case 1:
                post = _a.sent();
                if (!post)
...
router.put("/like/:id", auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                post = _a.sent();
                if (post.likes.filter(function (like) { return like.user.toString() === req.user.id; }).length >
                    0) {
...
// @access Private
router.put("/unlike/:id", auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
// @access Private
router.post("/comment/:id", [auth, check("text", "Text is required to make a post.").not().isEmpty()], function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
// @access Private
router.delete("/comment/:id/:comment_id", auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
